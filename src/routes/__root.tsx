...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Old School Mentalität. Moderne Stärke. Premium Gym Apparel aus Deutschland." },
      { property: "og:title", content: "OLD IRON — Geschmiedet aus Disziplin" },
      { property: "og:description", content: "Old School Mentalität. Moderne Stärke. Premium Gym Apparel aus Deutschland." },
      { property: "og:type", content: "website" },
      { name: "twitter:title", content: "OLD IRON — Geschmiedet aus Disziplin" },
      { name: "twitter:description", content: "Old School Mentalität. Moderne Stärke. Premium Gym Apparel aus Deutschland." },

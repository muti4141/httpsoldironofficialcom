  ...
  return (
    <div className="bg-background text-foreground min-h-screen">
      ...
      <main className="pt-stack-lg pb-stack-lg px-margin-mobile md:px-margin-desktop max-w-[800px] mx-auto text-center">
        <h1 className="font-display text-[56px] uppercase tracking-tight text-primary mt-12">Zahlung erhalten</h1>
        <p className="text-secondary mt-4">Deine Bestellung wird verarbeitet.</p>
        {order_id ? (
          <p className="text-outline mt-2 text-sm">Weiterleitung zu deiner Bestellung…</p>
        ) : (

...
export const products: Product[] = [
  ...
  // Pirinç Unu (Cream of Rice) en üstte
  {
    id: "cream-of-rice",
    name: "Cream of Rice",
    category: "carbs",
  ...
  },
  {
    ...
    price: 1250,
    originalPrice: 1450,
    image: "/__l5e/assets-v1/dbd57f28-dd67-44c3-9013-f9e36677f48f/liver-detox.png",
    subtitle: "60 Kapsül · Karaciğer Destek Formülü",
    servings: 60,
    weights: ["60 Kapsül"],
    flavors: ["Kapsül"],
    description: "Liver Detox — Gelişmiş Karaciğer Destek Formülü\n\nOLD IRON Liver Detox, yoğun antrenman, yüksek protein tüketimi ve modern yaşamın karaciğer üzerindeki yükünü hedef alan gelişmiş bir detoks ve temizleme formülüdür. Doğanın en güçlü karaciğer dostu bitkilerini tek bir kapsülde bir araya getirir.\n\nİçerik:\n- Deve Dikeni (Silymarin) — karaciğer hücrelerini korur ve yenilenmeyi destekler\n- Zerdeçal (Curcumin) — güçlü antioksidan ve anti-enflamatuar etki\n- Karahindiba Kökü — doğal detoks ve safra akışı desteği\n- Enginar Yaprağı — sindirim ve karaciğer fonksiyonlarını destekler\n\nÖne Çıkan Özellikler:\n- Karaciğer fonksiyonlarını destekler ve temizler\n- Hücresel yenilenmeyi dengeler\n- Antrenman performansını dolaylı olarak destekler\n- Günlük detoks rutini için ideal\n- 60 kapsül · 60 günlük kullanım\n\nKullanım: Günde 1 kapsül, tercihen yemekle birlikte.\n\nTakviye edici gıdadır. İlaç değildir. Hamileler, emziren anneler ve kronik rahatsızlığı olanlar kullanmadan önce doktora danışmalıdır.",
  },
  {
    id: "ashwagandha",
    name: "Ashwagandha",
    ...
    price: 1280,
    originalPrice: 1480,
    image: "/__l5e/assets-v1/ae4de8c2-d457-4517-b87c-77ffe6eabdd2/ashwagandha.jpg",
    subtitle: "60 Kapsül · Stres & Ruh Hali Desteği",
    servings: 60,
    weights: ["60 Kapsül"],
    flavors: ["Kapsül"],
    description: "Ashwagandha — Stres, Ruh Hali ve Rahatlama Desteği\n\nOLD IRON Ashwagandha, binlerce yıllık Ayurveda geleneğinden güç alan, modern yaşamın stres yükünü dengelemek için formüle edilmiş premium bir adaptojen desteğidir. Yoğun antrenman, iş hayatı ve günlük stresin beden üzerindeki etkilerini hedef alır.\n\nİçerik:\n- Yüksek saflıkta Ashwagandha kök ekstresi (Withania somnifera)\n- Adaptojen etki — bedenin stresle baş etme kapasitesini destekler\n- Doğal ruh hali ve mutluluk dengeleyici\n\nÖne Çıkan Özellikler:\n- Stres ve gerginliği azaltmaya yardımcı olur\n- Ruh hali ve mutluluk seviyesini destekler\n- Rahatlama ve uyku kalitesini iyileştirir\n- Yoğun antrenman sonrası toparlanmaya katkı sağlar\n- 60 kapsül · 60 günlük kullanım\n\nKullanım: Günde 1 kapsül, tercihen akşam yemeğiyle birlikte.\n\nTakviye edici gıdadır. İlaç değildir. Hamileler, emziren anneler ve kronik rahatsızlığı olanlar kullanmadan önce doktora danışmalıdır.",
  },
  {
    id: "whey-protein",
    name: "Whey Protein",
